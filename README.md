# ![@micromint1npm/iste-earum-quidem](logo-long.svg)
...
This works for all types that `@micromint1npm/iste-earum-quidem` can reflect, including unions, intersections, interfaces, classes,
